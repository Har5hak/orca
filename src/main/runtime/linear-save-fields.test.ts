...
describe('Linear save fields', () => {
  it('resolves a team by unambiguous exact name', async () => {
    ...
    vi.spyOn(linearTeams, 'listTeamsOrThrow').mockResolvedValue([
      {
        id: 'team-1',
        key: 'ENG',
        name: 'Engineering',
    ...
    await expect(runtime.resolveLinearTeamInput('engineering')).resolves.toMatchObject({
      id: 'team-1',
      workspaceId: 'workspace-1'
    })
  })
