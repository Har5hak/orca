...
export const ORCHESTRATION_WORKER_EXECUTION_PROFILE_RUNTIME_CAPABILITY =
  'orchestration.worker-execution-profile.v1' as const
...
export const RUNTIME_CAPABILITIES = [
  ...
  ORCHESTRATION_WORKER_EXECUTION_PROFILE_RUNTIME_CAPABILITY,
