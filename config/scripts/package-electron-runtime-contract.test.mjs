...
describe('Electron runtime package contract', () => {
  ...
  it('keeps Windows and Linux package builds off macOS native helper builds', () => {
    ...
    expect(scripts['build:desktop']).not.toContain('build:codex-lab-keychain-writer-macos')
    ...
    expect(scripts['build:win']).not.toContain('build:codex-lab-keychain-writer-macos')
    ...
    expect(scripts['build:linux']).not.toContain('build:codex-lab-keychain-writer-macos')
    ...
    expect(scripts['build:mac']).toContain('pnpm run build:codex-lab-keychain-writer-macos')
